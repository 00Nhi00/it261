...
if(isset($_POST['reg_user'])) {
    ...
    // our logic is this - is passowrd_1 !== to password_2
    ...
    //if we are sucessful, then we will be directed to our login page!!!
    // if(!empty($first_name && $last_name && $email && $username && $password_1 && $password_2) && ($password_1 == $password_2)){
