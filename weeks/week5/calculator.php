...
<?php
//we'll start with the server request method
...
if ($speed != 0 && $hour != 0 && $fuel != 0){
  ...
  echo '
  <div class="box" style="background-color:gray; width:450px"">
  <p style="color:#FFFFFF; text-align:left">Hello '.$name.', You will be travelling a total of '.number_format($total_hours,2).' hours, taking '.number_format($total_days,2).' days <br> And, you will be using '.number_format($total_gallons,0).' gallons of gas, costing you '.number_format($total_cost,0).' dollars</p>
  </div>
  ';
} 
   }
