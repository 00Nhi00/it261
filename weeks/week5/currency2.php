...
if($_SERVER['REQUEST_METHOD']== 'POST'){
  ...
  // if(empty($_POST['bank'])){
  //   echo'<p class="error">Please fill out your bank</p>';
  // }
  ...
  <p>You now have <b>'.$dollars.' American dollars </b> and we will be emailing you at '.$email.' with your information, as well as depositing your funds at <b>'.$bank.' bank!</b></p>
  </div>
  ';
} 
